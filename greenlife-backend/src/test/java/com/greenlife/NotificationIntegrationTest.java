...
public class NotificationIntegrationTest {
        ...
        void testNotificationOnCheckoutAndStatusTransitions() throws Exception {
                ...
                mockMvc.perform(get("/api/notifications")
                                ...
                                .andExpect(jsonPath("$.content[0].userId").doesNotExist()); // Verification: Do NOT
                                                                                            // expose userId
                ...
                waitForNotifications(6); // +2 (ORDER_DELIVERED for customer & PAYMENT_SUCCESS for COD delivered
                                         // customer)
                ...
                mockMvc.perform(get("/api/notifications")
                                ...
                                .andExpect(jsonPath("$.content[*].type",
                                                hasItems("PAYMENT_SUCCESS", "ORDER_DELIVERED")));
        }
        ...
        void testNotificationOnPaymentCallback() throws Exception {
                ...
                mockMvc.perform(get("/api/notifications")
                                ...
                                .andExpect(jsonPath("$.content", hasSize(2)))
                                .andExpect(jsonPath("$.content[*].type",
                                                hasItems("ORDER_CONFIRMED", "PAYMENT_SUCCESS")));
        ...
        void testNotificationOnWishlistRestock() throws Exception {
                ...
                mockMvc.perform(get("/api/notifications")
                                ...
                                .andExpect(jsonPath("$.content[0].title",
                                                containsString("Sản phẩm yêu thích đã có hàng trở lại")));
        }
        ...
        void testPaginationCappingAndSorting() throws Exception {
                ...
                mockMvc.perform(get("/api/notifications?page=0&size=150")
                                ...
                                .andExpect(jsonPath("$.content[0].title", is("Announce 119"))) // Sorted by createdAt
                                                                                               // DESC
