    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/categories", "/api/categories/**", "/api/products", "/api/products/**", "/api/reviews/plants/**", "/api/reviews/stores/**", "/api/services", "/api/services/{id}", "/api/blogs", "/api/blogs/{id}", "/api/blogs/slug/**", "/api/blogs/categories", "/api/administrative/**", "/api/stores/public").permitAll()
