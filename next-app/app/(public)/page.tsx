...
import { plants, services, blogPosts } from '@/lib/mockData';
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/shop" className="btn-primary !px-8 !py-4 flex items-center gap-2 text-lg">
      ...
      <section className="py-24 px-6 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            ...
            <Link href="/shop" className="group flex items-center gap-2 font-bold text-primary hover:gap-3 transition-all">
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto bg-primary rounded-[60px] p-12 lg:p-24 relative overflow-hidden text-white">
          ...
          <div className="max-w-2xl relative z-10">
            ...
            <Link href="/services" className="mt-16 inline-block py-4 px-10 bg-accent text-primary rounded-full font-bold hover:bg-nature-200 transition-all">
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {blogPosts.map(post => (
              <Link href={`/blog`} key={post.id} className="flex flex-col lg:flex-row gap-6 p-4 rounded-3xl hover:bg-slate-50 transition-all group">
