...
- Name: ai-diagnosis.spec.ts >> AI Diagnosis Flow >> TC-AI-06: Product recommendations appear after diagnosis
- Location: src\tests\e2e\ai-diagnosis.spec.ts:97:3
...
Locator: getByText(/sản phẩm gợi ý|đề xuất/i).first()
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for getByText(/sản phẩm gợi ý|đề xuất/i).first()
