...
- Name: ai-diagnosis.spec.ts >> AI Diagnosis Flow >> TC-AI-02: Camera toggle button is visible
- Location: src\tests\e2e\ai-diagnosis.spec.ts:41:3
...
Locator: getByRole('button', { name: /camera|webcam/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /camera|webcam/i })
