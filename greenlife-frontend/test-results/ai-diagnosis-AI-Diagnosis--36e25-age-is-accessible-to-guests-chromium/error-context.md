...
- Name: ai-diagnosis.spec.ts >> AI Diagnosis Flow >> TC-AI-01: AI Diagnosis page is accessible to guests
- Location: src\tests\e2e\ai-diagnosis.spec.ts:34:3
...
Locator: getByText(/tải ảnh lên|chụp ảnh/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/tải ảnh lên|chụp ảnh/i)
