$sqlFile = "c:\FPT\GreenLife\swp391-su26-ai-audit-project-swp391_se20a04_group-05-3\database\patches\patch_11_auth_schema_alignment.sql"
if (Test-Path $sqlFile) {
    ...
    try {
        ...
        Write-Output "Auth schema alignment patch 11 applied successfully!"
    } catch {
