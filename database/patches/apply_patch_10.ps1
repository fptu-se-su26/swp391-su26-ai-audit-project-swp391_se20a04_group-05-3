$sqlFile = "c:\FPT\GreenLife\swp391-su26-ai-audit-project-swp391_se20a04_group-05-3\database\patches\patch_10_blog_indexes.sql"
if (Test-Path $sqlFile) {
    ...
    try {
        ...
        Write-Output "Blog indexes and columns patch applied successfully!"
    } catch {
