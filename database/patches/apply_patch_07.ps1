$sqlFile = "c:\FPT\GreenLife\swp391-su26-ai-audit-project-swp391_se20a04_group-05-3\database\patches\patch_07_customer_addresses.sql"
if (Test-Path $sqlFile) {
    ...
    try {
        ...
        Write-Output "Customer Address patch applied successfully!"
    } catch {
