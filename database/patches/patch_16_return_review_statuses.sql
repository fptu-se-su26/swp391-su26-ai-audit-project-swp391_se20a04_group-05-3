...
IF COL_LENGTH(N'dbo.orders', N'return_reject_reason') IS NULL
BEGIN
    PRINT 'Adding column return_reject_reason to dbo.orders...';
    ALTER TABLE dbo.orders ADD return_reject_reason NVARCHAR(500) NULL;
END;
GO
